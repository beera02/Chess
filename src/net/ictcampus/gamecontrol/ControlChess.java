...
/**
 * Klasse ControlChess Klasse um alle Figuren zu erstellen mit Methoden um das
...
public class ControlChess {
     ...
     /**
      * Konstruktor der Klasse ControlChess, der wichtige Methoden ausführt um den
      * Anfang des Spiels zu definieren
      */
     public ControlChess() {
     ...
     /**
      * Methode ausgangslage() welche alle Figuren erstellt, den richtigen Panels
      * hinzufügt und die Anfangskordinaten setzt
      */
     public void ausgangslage() {
          ...
          dame_weiss.setxPos(4);
          dame_weiss.setyPos(0);
          koenig_weiss.setxPos(3);
     ...
     /**
      * Methode wechsleSpieler() um den Spieler zu wechseln resp. die Farbe der
      * aktivierten Buttons zu wechseln
      * 
      * @param farbe
      *             Um festzulegen welche Farbe aktiv wird
      */
      ...
      * @param x
      *             xKordinate der neuen Position
      * @param y
      *             yKordinate der neuen Position
      */
     ...
     public FeldGUI getFeld() {
          return feld;
     }

     public void setFeld(FeldGUI feld) {
          this.feld = feld;
     }
