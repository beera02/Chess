...
public class ButtonListener implements ActionListener {
     ...
     /**
      * Konstruktor um festzulegen welche Informationen bei der Erstellung einer
      * Instanz mitgegeben werden müssen
      * 
      * @param ta
      *             Textarea
      * @param tf
      ...
      *             ControlChess Objekt
      */
     public ButtonListener(JTextArea ta , JTextField tf , JButton b , Spieler spieler1 ,
               Spieler spieler2 , ControlChess control) {
          this.ta = ta;
          this.tf = tf;
          this.b = b;
     ...
     /**
      * Methode welche auf den OK! Button hört und je nach dem in welcher Runde man
      * sich befindet, anders handelt
      */
     @Override
          ...
          if ((e.getActionCommand() == "OK!") & (runde == 2) & !(tf.getText().equals(""))) {
               ...
               if (randomStarter == 1.0) {
                    ...
                    ta.setText("Der Spieler 2 heisst nun " + spieler2.getSpielerName() + "!\n"
                              + spieler2.getSpielerName()
                              + ": Sie wurden ausgewählt, das Spiel mit Weiss zu starten!");
               } else {
                    spieler1.setSpielerFarbe("weiss");
                    spieler2.setSpielerFarbe("schwarz");
                    ta.setText("Der Spieler 2 heisst nun " + spieler2.getSpielerName() + "!\n"
                              + spieler1.getSpielerName()
                              + ": Sie wurden ausgewählt, das Spiel mit Weiss zu starten!");
               }
               runde = 3;
               tf.setEnabled(false);
